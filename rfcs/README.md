...
| [0011](0011-judgment-currency-anchor.md) | A currency anchor for judgment artifacts — detecting staleness and rollback | Draft | Research line (cross-project artifact: pack-discovery format, a currency registry, consumer protocols) — outside the specification |
