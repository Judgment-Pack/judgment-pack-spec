...
PAGES = (
    ...
    Page(
        ...
        "Proposals (RFCs)",
        "Requests for Comments — design proposals and their disposition records, none of them part of the specification.",
        "proposals",
        "Non-normative",
        source_ref="main",
    ),
    ...
    Page(
        ...
        "Rejected proposal: the project declines to standardize planner selection, including the proposed selection query.",
        "proposals",
        "Rejected proposal",
        source_ref="main",
    ),
    ...
    groups = (
        ...
        (
            ...
            (
                ...
                ("Proposals (RFCs)", "Design proposals, their disposition records, and the change process.", "rfcs/index.html"),
            ),
        ),
        (
...
SLIDES: tuple[Slide, ...] = (
    ...
    Slide(
        ...
        note=(
            "Measured across 54 tests on the file format, plus 20 decision scenarios replayed through "
    ...
    Slide(
        ...
        points=(
            ...
            "and an agreed way to turn one into an answer — held in place by 54 tests on the format "
